...
cpp_graphical_lasso <- function(S, rho, thr, maxit, w_init = NULL, wi_init = NULL) {
    .Call('_PLNmodels_cpp_graphical_lasso', PACKAGE = 'PLNmodels', S, rho, thr, maxit, w_init, wi_init)
}
