...
newton_optimize_diagonal <- function(data, params, config) {
...
newton_optimize_fixed <- function(data, params, config) {
...
newton_optimize_vestep_spherical <- function(data, params, B, Omega, config) {
    .Call('_PLNmodels_newton_optimize_vestep_spherical', PACKAGE = 'PLNmodels', data, params, B, Omega, config)
}
