...
#' For each site, 4 additional covariates are known. Subsample of ther original datasets studied by Fossheim et al, 2006.
#'
...
#' * 4 covariates for latitude, longitude, depth (in meters), temperature (in Celcius degrees).
#'
