...
#' @param backend optimization backend, either `"builtin"` (default, joint Newton on (M,ψ,R), combined with the partial E-step `maxit_ve = 1`) or `"nlopt"` (CCSAQ). `"builtin"` consistently finds a better ELBO across the penalty path at the cost of being slower.
