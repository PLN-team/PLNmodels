...
# warm  = PLNnetwork(Abundance ~ 1, data = trichoptera, control_main = list(warm = TRUE , trace = 0)),
# cold  = PLNnetwork(Abundance ~ 1, data = trichoptera, control_main = list(warm = FALSE, trace = 0)),
#   times = 20)
