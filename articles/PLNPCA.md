...
|------:|---------:|-----------:|-----------:|-----------:|-----------:|
|     1 |       34 | -1041.9942 | -1108.1551 | -1075.9942 | -1121.6349 |
|     2 |       50 |  -732.0053 |  -829.3008 |  -782.0053 |  -860.5856 |
|     3 |       65 |  -640.3186 |  -766.8028 |  -705.3186 |  -825.4552 |
|     4 |       79 |  -599.5948 |  -753.3217 |  -678.5948 |  -842.9388 |
...
|:------|------:|:---------|:-------|:--------|:----------|:-----------|
| out   |     1 | 34       | 3      | nlopt   | -36014.32 | 605        |
| elt   |     2 | 50       | 3      | nlopt   | -36324.3  | 1124       |
| elt.1 |     3 | 65       | 3      | nlopt   | -36415.99 | 846        |
| elt.2 |     4 | 79       | 3      | nlopt   | -36456.72 | 1365       |
...
|:---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| (Intercept) | -7.433875 | -8.03589 | -3.023879 | -6.871957 | -0.5380139 | -3.852134 | -6.364646 | -5.798877 | -7.297419 | -3.513979 | -4.074111 | -5.048212 | -4.33599 | -5.894181 | -3.922257 | -7.133481 | -2.595305 |
...
|     |        PC1 |        PC2 |        PC3 |
|:----|-----------:|-----------:|-----------:|
| Che | -0.2047000 |  0.3227035 | -0.0285753 |
| Hyc | -0.4344503 | -0.2257518 |  0.2060433 |
| Hym | -0.1308710 |  0.1695868 |  0.2943251 |
| Hys | -0.4338038 |  0.3648380 |  0.2736026 |
| Psy |  0.0510274 |  0.0170880 | -0.0710481 |
| Aga |  0.0683846 |  0.2931794 |  0.1981606 |
...
|       PC1 |        PC2 |        PC3 |
|----------:|-----------:|-----------:|
| -1.751292 | -0.4480802 |  0.7105037 |
|  3.396068 |  0.9759212 |  2.0252628 |
|  7.222332 | -1.1397499 |  0.5534184 |
|  6.334326 | -1.4054991 | -1.6560674 |
|  4.613787 | -0.0521214 | -1.0063938 |
|  3.912331 |  0.8034919 |  0.4452911 |
...
```
    ...
    ##        65 -640.319 -766.803 -705.319 -825.455
    ## ==================================================================
    ## * Useful fields
...
```
    ...
    ## List of 4
    ##  $ coord  : num [1:49, 1:3] -1.75 3.4 7.22 6.33 4.61 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##   .. ..$ : chr [1:49] "1" "2" "3" "4" ...
    ##   .. ..$ : chr [1:3] "Dim.1" "Dim.2" "Dim.3"
    ##  $ cos2   : num [1:49, 1:3] 0.813 0.695 0.97 0.895 0.954 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##   .. ..$ : chr [1:49] "1" "2" "3" "4" ...
    ##   .. ..$ : chr [1:3] "Dim.1" "Dim.2" "Dim.3"
    ##  $ contrib: num [1:49, 1:3] 0.628 2.36 10.676 8.212 4.357 ...
    ##   ..- attr(*, "dimnames")=List of 2
    ##   .. ..$ : chr [1:49] "1" "2" "3" "4" ...
    ##   .. ..$ : chr [1:3] "Dim.1" "Dim.2" "Dim.3"
    ##  $ dist   : Named num [1:49] 1.94 4.07 7.33 6.7 4.72 ...
...
```
    ...
    ##       Dim.1       Dim.2      Dim.3
    ## 1 -1.751292 -0.44808020  0.7105037
    ## 2  3.396068  0.97592122  2.0252628
    ## 3  7.222332 -1.13974987  0.5534184
    ## 4  6.334326 -1.40549908 -1.6560674
    ## 5  4.613787 -0.05212141 -1.0063938
    ## 6  3.912331  0.80349193  0.4452911
...
```
    ...
    ## Dim.1   488.5991         39.67161                    39.67161
    ## Dim.2   286.4598         23.25899                    62.93061
    ## Dim.3   214.1434         17.38729                    80.31789
