...
On **Windows**, the package builds and installs correctly by [including static libraries](https://github.com/rwinlib/nlopt) on compilation. 

### R Package installation

#### CRAN dependencies

**PLNmodels** needs the following CRAN R packages, so check that their are installed on your computer.

```{r dependencies CRAN, eval = FALSE}
library(R6)
library(glassoFast)
library(Matrix)
library(Rcpp)
...
- Windows users may want to use [the binary version of the package](https://github.com/jchiquet/PLNmodels/releases/download/v0.7.0.1/PLNmodels_0.7.0.1.zip)
