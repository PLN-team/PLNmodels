...
- **PLN**[^1][^2]: unpenalized multivariate Poisson regression, with several covariance structures (full, diagonal, spherical, fixed, or a genetic/heritability structure).
- **PLNPCA**[^3]: probabilistic Poisson PCA — a rank-constrained covariance for dimension reduction and visualization.
- **PLNLDA**[^1]: Poisson lognormal discriminant analysis[^4] for the supervised classification of count data.
