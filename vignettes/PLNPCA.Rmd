...
The main function `PLNPCA` integrates some features of the **future** package to perform parallel computing: we set our plan now to speed the fit by relying on 2 workers:
