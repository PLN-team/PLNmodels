...
```{r offset_trichopera}
trichoptera$TotalCounts %>% head() %>% knitr::kable()
```
...
select(trichoptera, -TotalCounts, -Abundance) %>% head() %>% knitr::kable()
```
